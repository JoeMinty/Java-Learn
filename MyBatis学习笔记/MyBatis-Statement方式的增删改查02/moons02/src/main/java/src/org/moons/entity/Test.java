...
public class Test {
		...
		//Connection -  SqlSession操作MyBatis
				...
				String statement = "org.moons.entity.studentMapper.queryStudentByStuno";
 		...
 		public static void queryAllStudents() throws IOException {
			//Connection -  SqlSession操作MyBatis
					...
					String statement = "org.moons.entity.studentMapper."+"queryAllStudents";
